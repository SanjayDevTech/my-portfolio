...
export default function Profile() {
	return (
		<div className="relative h-32 md:h-36 w-full flex justify-center items-center">
			<div className="h-32 w-32 md:h-36 md:w-36 rounded-full border-white border-4  absolute">
				<img
