		...
		>
			<div className="--home-section-profile-name-container">
				...
				<div className="--home-section-profile-contact">
					...
					<button
						title="https://github.com/SanjayDevTech"
						onClick={() => {
							window.open('https://github.com/SanjayDevTech', '_blank');
						}}
						className="--home-section-profile-contact-btn"
					>
						<GitHubIcon className="--home-section-profile-contact-btn-icon" />
						GitHub
					</button>
				</div>
			</div>
